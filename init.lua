...
vim.schedule(function()
  vim.opt.clipboard = 'unnamed' -- from unnamedplus to unnamed
end)
...
vim.keymap.set('n', '<leader>wd', vim.diagnostic.setqflist, { desc = 'Open [W]orkspace [D]iagnostic' })
vim.keymap.set('n', '<F2>', vim.diagnostic.goto_next, { desc = 'Move to the next diagnostic.' })
